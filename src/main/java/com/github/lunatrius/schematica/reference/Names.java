...
public final class Names {
    public static final class Config {
        ...
        public static final String DUMP_BLOCK_LIST = "Dump Block List";
        ...
        public static final String ALPHA_ENABLED = "Alpha Enabled";
