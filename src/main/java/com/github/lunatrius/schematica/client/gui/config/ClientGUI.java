...
public class ClientGUI {
    ...
    public static void display() {
        ...
        list.addNewText(Names.Config.SCHEMATIC_DIRECTORY, ConfigurationHandler.SCHEMATIC_DIRECTORY_STR, true, Names.Config.SCHEMATIC_DIRECTORY_DESC);
        list.addNewButton(Names.Config.EXTRA_AIR_BLOCKS, 0);

        list.addLabel("");
        list.addLabel("Printer");
        list.addNewButton(Names.Config.HOTBAR_SLOTS, 0);
        list.addNewRuleButton(Names.Config.DESTROY_BLOCKS, String.valueOf(ConfigurationHandler.destroyBlocks), true, Names.Config.DESTROY_BLOCKS_DESC, 0);
        list.addNewRuleButton(Names.Config.DESTROY_INSTANTLY, String.valueOf(ConfigurationHandler.destroyInstantly), true, Names.Config.DESTROY_INSTANTLY_DESC, 0);
        list.addNewRuleButton(Names.Config.PLACE_ADJACENT, String.valueOf(ConfigurationHandler.placeAdjacent), true, Names.Config.PLACE_ADJACENT_DESC, 0);
        list.addNewRuleSlider(Names.Config.PLACE_DELAY, false, Names.Config.PLACE_DELAY_DESC, 0, 20, 1, 0);
        list.addNewRuleSlider(Names.Config.PLACE_DISTANCE, false, Names.Config.PLACE_DISTANCE_DESC, 0, 5, 5, 0);
        list.addNewRuleButton(Names.Config.PLACE_INSTANTLY, String.valueOf(ConfigurationHandler.placeInstantly), true, Names.Config.PLACE_INSTANTLY_DESC, 0);
        list.addNewRuleSlider(Names.Config.TIMEOUT, false, Names.Config.TIMEOUT_DESC, 0, 100, 10, 0);

        list.addLabel("");
        list.addLabel("Renderer");
        list.addNewRuleSlider(Names.Config.ALPHA, false, Names.Config.ALPHA_DESC, 0f, 1.0f, 0, 0);
        list.addNewRuleButton(Names.Config.ALPHA_ENABLED, String.valueOf(ConfigurationHandler.enableAlpha), true, Names.Config.ALPHA_ENABLED_DESC, 0);
        list.addNewRuleSlider(Names.Config.BLOCK_DELTA, false, Names.Config.BLOCK_DELTA_DESC, 0f, 0.2f, 0.005f, 0);
        list.addNewRuleButton(Names.Config.HIGHLIGHT, String.valueOf(ConfigurationHandler.highlight), true, Names.Config.HIGHLIGHT_DESC, 0);
        list.addNewRuleButton(Names.Config.HIGHLIGHT_AIR, String.valueOf(ConfigurationHandler.highlightAir), true, Names.Config.HIGHLIGHT_AIR_DESC, 0);
        list.addNewRuleSlider(Names.Config.RENDER_DISTANCE, false, Names.Config.RENDER_DISTANCE_DESC, 2, 16, 8, 0);
    }
